          ...
          <table className="w-full">
            <tbody>
              <tr>
                ...
                <td className="px-4 py-2 border-b border-gray-300">{user.bpjsNumber}</td>
              </tr>
              <tr>
                <td className="px-4 py-2 font-semibold border-b border-gray-300">Nama</td>
                <td className="px-4 py-2 border-b border-gray-300">{user.familyContact.name}</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="px-4 py-2 border-b border-gray-300">{user.familyContact.address}</td>
              </tr>
            </tbody>
          </table>
